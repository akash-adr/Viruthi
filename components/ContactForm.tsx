    ...
    return (
      <section id="contact" style={{ width: '100%', background: '#FFFFFF', padding: '160px 5vw', display: 'flex', justifyContent: 'center', borderTop: '1px solid rgba(13,13,13,0.08)' }}>
        ...
        >
          ...
          <p style={{ fontFamily: 'var(--font-satoshi)', fontSize: '20px', fontWeight: 300, color: 'rgba(13,13,13,0.85)', lineHeight: 1.6, marginBottom: '48px', maxWidth: '400px', margin: '0 auto 48px' }}>
    ...
    <section id="contact" style={{ width: '100%', background: '#FFFFFF', borderTop: '1px solid rgba(13,13,13,0.08)', position: 'relative' }}>
      ...
      <div style={{ width: '100%', padding: '120px 5vw 80px', borderBottom: '1px solid rgba(13,13,13,0.08)' }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '64px', alignItems: 'flex-start' }}>
          ...
          <div>
            <span style={{ fontFamily: 'var(--font-satoshi)', fontSize: '10px', fontWeight: 600, letterSpacing: '0.2em', color: 'rgba(13,13,13,0.85)', textTransform: 'uppercase', marginBottom: '24px', display: 'block' }}>
            ...
            <p style={{ fontFamily: 'var(--font-satoshi)', fontSize: 'clamp(20px, 2.5vw, 26px)', fontWeight: 300, color: 'rgba(13,13,13,0.85)', margin: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%' }}>
            <div style={{ padding: '24px 32px', border: '1px solid rgba(13,13,13,0.1)', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '24px', transition: 'all 0.3s ease', cursor: 'pointer' }}
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-satoshi)', fontSize: '11px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(13,13,13,0.85)', marginBottom: '4px' }}>Call Us</div>
            ...
            <div style={{ padding: '24px 32px', border: '1px solid rgba(13,13,13,0.1)', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '24px', transition: 'all 0.3s ease', cursor: 'pointer' }}
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-satoshi)', fontSize: '11px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(13,13,13,0.85)', marginBottom: '4px' }}>Email Us</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
              <a href="#" style={{ padding: '24px 16px', border: '1px solid rgba(13,13,13,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', transition: 'all 0.3s ease', cursor: 'pointer', color: '#0D0D0D', textDecoration: 'none', background: '#FFFFFF' }}
                ...
                <span style={{ fontFamily: 'var(--font-satoshi)', fontSize: '10px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(13,13,13,0.85)' }}>LinkedIn</span>
              </a>
              <a href="#" style={{ padding: '24px 16px', border: '1px solid rgba(13,13,13,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', transition: 'all 0.3s ease', cursor: 'pointer', color: '#0D0D0D', textDecoration: 'none', background: '#FFFFFF' }}
                 onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(13,13,13,0.3)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                 onMouseOut={e => { e.currentTarget.style.borderColor = 'rgba(13,13,13,0.1)'; e.currentTarget.style.transform = 'translateY(0)'; }}>
                ...
                <span style={{ fontFamily: 'var(--font-satoshi)', fontSize: '10px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(13,13,13,0.85)' }}>Instagram</span>
              </a>
              <a href="#" style={{ padding: '24px 16px', border: '1px solid rgba(13,13,13,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', transition: 'all 0.3s ease', cursor: 'pointer', color: '#0D0D0D', textDecoration: 'none', background: '#FFFFFF' }}
                 onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(13,13,13,0.3)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                 onMouseOut={e => { e.currentTarget.style.borderColor = 'rgba(13,13,13,0.1)'; e.currentTarget.style.transform = 'translateY(0)'; }}>
                ...
                <span style={{ fontFamily: 'var(--font-satoshi)', fontSize: '10px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(13,13,13,0.85)' }}>YouTube</span>
              </a>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              ...
              >
                ...
                <p style={{ fontFamily: 'var(--font-satoshi)', fontSize: '20px', fontStyle: 'italic', color: 'rgba(13,13,13,0.85)', marginTop: '16px' }}>
